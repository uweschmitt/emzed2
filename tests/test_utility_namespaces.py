...
def testfoumulaadd():
    import emzed.utils
    assert emzed.utils.addmf("H2O") == "H2O"
    assert emzed.utils.addmf("H2O", "O") == "H2O2"
    assert emzed.utils.addmf("H2O", "-O") == "H2"
    assert emzed.utils.addmf("H2O", "-H2") == "O"
    assert emzed.utils.addmf("H2O", "O", "O", "O2") == "H2O5"
    assert emzed.utils.addmf("(CH2)7", "COOH", "Cl", "-H2O") == "C8H13OCl"
