# -*- coding: utf-8 -*-
#
# eMZed documentation build configuration file, created by
...
latex_documents = [
  ('index', 'emzed.tex', u'emzed Documentation',
   u'Uwe Schmitt', 'manual'),
]
...
man_pages = [
    ('index', 'emzed', u'emzed Documentation',
     [u'Uwe Schmitt'], 1)
]
