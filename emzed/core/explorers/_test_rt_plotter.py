...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.widget = EICPlotterWidget(self.centralwidget)
...
from eic_plotting_widget import EICPlotterWidget
...
class MainWindow(QtGui.QMainWindow, Ui_MainWindow):
    def __init__(self, parent=None, f=QtCore.Qt.WindowFlags()):
        ...
        self.setupUi(self)
        data = [(range(10), range(10)), (range(1, 11), range(10))]
        self.widget.plot_(data)
        self.widget.replot()
