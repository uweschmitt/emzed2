...
class Ui_SpectraSelector(object):
    def setupUi(self, _SpectraSelector):
        _SpectraSelector.setObjectName(_fromUtf8("_SpectraSelector"))
        _SpectraSelector.setGeometry(QtCore.QRect(0, 0, 275, 118))
        self._horizontalLayout = QtGui.QHBoxLayout(_SpectraSelector)
        ...
        self._frame = QtGui.QFrame(_SpectraSelector)
        ...
        self.retranslateUi(_SpectraSelector)
        QtCore.QMetaObject.connectSlotsByName(_SpectraSelector)

    def retranslateUi(self, _SpectraSelector):
        _SpectraSelector.setWindowTitle(_translate("SpectraSelector", "Form", None))
...
class _SpectraSelector(QtGui.QWidget, Ui_SpectraSelector):
...
if __name__ == "__main__":
    ...
    _SpectraSelector = QtGui.QWidget()
    ui = Ui_SpectraSelector()
    ui.setupUi(_SpectraSelector)
    _SpectraSelector.show()
    sys.exit(app.exec_())
