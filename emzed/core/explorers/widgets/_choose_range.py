...
class Ui_ChooseRange(object):
    def setupUi(self, ChooseRange):
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.label_lower_bound.sizePolicy().hasHeightForWidth())
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.label_upper_bound.sizePolicy().hasHeightForWidth())
    ...
    def retranslateUi(self, ChooseRange):
        ...
        self.column_name.setText(_translate("ChooseRange", "dsffdsf", None))
